...
<pre style="position: relative;"><strong>Input:</strong> nums = [0,1,7,4,4,5], lower = 3, upper = 6
...
<pre style="position: relative;"><strong>Input:</strong> nums = [1,7,9,2,5], lower = 11, upper = 11
