...
<pre style="position: relative;"><strong>Input:</strong> heights = [4,2,7,6,9,14,12], bricks = 5, ladders = 1
...
<pre style="position: relative;"><strong>Input:</strong> heights = [4,12,2,7,3,18,20,3,19], bricks = 10, ladders = 2
<strong>Output:</strong> 7
<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong>Example 3:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> heights = [14,3,19,3], bricks = 17, ladders = 0
