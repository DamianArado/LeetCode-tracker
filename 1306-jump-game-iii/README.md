...
<pre style="position: relative;"><strong>Input:</strong> arr = [4,2,3,0,3,1,2], start = 5
...
<pre style="position: relative;"><strong>Input:</strong> arr = [4,2,3,0,3,1,2], start = 0
<strong>Output:</strong> true 
<strong>Explanation: 
...
<pre style="position: relative;"><strong>Input:</strong> arr = [3,0,2,1,2], start = 2
