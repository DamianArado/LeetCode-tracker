<h2>1835. Find XOR Sum of All Pairs Bitwise AND</h2><h3>Hard</h3><hr><div><p>The <strong>XOR sum</strong> of a list is the bitwise <code>XOR</code> of all its elements. If the list only contains one element, then its <strong>XOR sum</strong> will be equal to this element.</p>
...
<ul data-read-aloud-multi-block="true">
	<li><code>1 &lt;= arr1.length, arr2.length &lt;= 10<sup style="">5</sup></code></li>
	<li><code>0 &lt;= arr1[i], arr2[j] &lt;= 10<sup style="">9</sup></code></li>
</ul>
</div>