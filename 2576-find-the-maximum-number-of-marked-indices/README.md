...
<pre style="position: relative;"><strong>Input:</strong> nums = [3,5,2,4]
...
<pre style="position: relative;"><strong>Input:</strong> nums = [9,2,5,4]
...
<pre style="position: relative;"><strong>Input:</strong> nums = [7,6,8]
