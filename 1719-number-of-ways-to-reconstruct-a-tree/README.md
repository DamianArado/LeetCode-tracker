<h2><a href="https://leetcode.com/problems/number-of-ways-to-reconstruct-a-tree/">1719. Number Of Ways To Reconstruct A Tree</a></h2><h3>Hard</h3><hr><div><p>You are given an array <code>pairs</code>, where <code>pairs[i] = [x<sub>i</sub>, y<sub>i</sub>]</code>, and:</p>
...
<pre style="position: relative;"><strong>Input:</strong> pairs = [[1,2],[2,3]]
...
<pre style="position: relative;"><strong>Input:</strong> pairs = [[1,2],[2,3],[1,3]]
...
<pre style="position: relative;"><strong>Input:</strong> pairs = [[1,2],[2,3],[2,4],[1,5]]
<strong>Output:</strong> 0
<strong>Explanation:</strong> There are no valid rooted trees.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
