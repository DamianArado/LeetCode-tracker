    ...
    We'll use the BST iterator class to iterate over the inorder of the BST and then we will take 2 pointers
    i and j for inorder and reverse inorder and then we'll check if their sum is equal to k.
