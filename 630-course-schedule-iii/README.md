...
<pre style="position: relative;"><strong>Input:</strong> courses = [[100,200],[200,1300],[1000,1250],[2000,3200]]
...
<pre style="position: relative;"><strong>Input:</strong> courses = [[1,2]]
<strong>Output:</strong> 1
<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong>Example 3:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> courses = [[3,2],[4,3]]
