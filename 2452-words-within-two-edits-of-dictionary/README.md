...
<pre style="position: relative;"><strong>Input:</strong> queries = ["word","note","ants","wood"], dictionary = ["wood","joke","moat"]
...
<pre style="position: relative;"><strong>Input:</strong> queries = ["yes"], dictionary = ["not"]
