...
<pre style="position: relative;"><strong>Input:</strong> roads = [[0,1],[0,2],[0,3]], seats = 5
...
<pre style="position: relative;"><strong>Input:</strong> roads = [[3,1],[3,2],[1,0],[0,4],[0,5],[4,6]], seats = 2
...
<pre style="position: relative;"><strong>Input:</strong> roads = [], seats = 1
